...
require_relative 'double_dog/database/inmemory/item.rb'
require_relative 'double_dog/database/inmemory/order.rb'
require_relative 'double_dog/database/inmemory/session.rb'
require_relative 'double_dog/database/inmemory/user.rb'
require_relative 'double_dog/database/inmemory/inmemory.rb'
